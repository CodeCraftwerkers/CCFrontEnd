...
import { getEventById, updateEvent, deleteEvent } from "../services/ApiEvent.jsx";
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 bg-gray-100 py-12">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Editar evento</h1>
        ...
        >
          <div>
            <label className="block font-semibold mb-2 text-gray-700">Título</label>
            <input
              type="text"
              name="title"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block font-semibold mb-2 text-gray-700">Inicio</label>
              <input
                type="datetime-local"
                name="startDateTime"
            ...
            <div>
              <label className="block font-semibold mb-2 text-gray-700">Fin</label>
              <input
                type="datetime-local"
                name="endDateTime"
        ...
        {showConfirm && (
          <ConfirmModal
            message="¿Estás seguro que quieres borrar este evento?"
