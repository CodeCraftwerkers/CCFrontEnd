...
import ChangePasswordModal from "../components/dashboard/ChangePasswordModal.jsx"; // 👈 Import agregado
...
export default function ProfilePage() {
  ...
  <button
    ...
    className="px-6 py-2 h-11 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-medium rounded-lg hover:from-orange-600 hover:to-orange-700 transition cursor-pointer"
  >
    Editar perfil
  </button>
  ...
  <div className="h-11 flex items-center">
    <LogoutButton />
        ...
        {showChangePassword && ( // 👈 renderiza modal
